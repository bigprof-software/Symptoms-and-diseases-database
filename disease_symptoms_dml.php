...
// Data functions for table disease_symptoms
...
function disease_symptoms_insert(){
	...
	$data['disease'] = makeSafe($_POST['disease']);
	$data['symptom'] = makeSafe($_POST['symptom']);
	$data['expected_probability'] = makeSafe($_POST['expected_probability']);
	$data['minimum'] = makeSafe($_POST['minimum']);
	$data['maximum'] = makeSafe($_POST['maximum']);
	$data['reading_other_value'] = makeSafe($_POST['reading_other_value']);
	$data['comments'] = makeSafe($_POST['comments']);
	if($data['disease']== ''){
		echo StyleSheet() . "\n\n<div class=\"Error\">" . $Translation['error:'] . " 'Disease': " . $Translation['field not null'] . '<br /><br />';
	...
	sql('insert into `disease_symptoms` set `disease`=' . (($data['disease'] != '') ? "'{$data['disease']}'" : 'NULL') . ', `symptom`=' . (($data['symptom'] != '') ? "'{$data['symptom']}'" : 'NULL') . ', `expected_probability`=' . (($data['expected_probability'] != '') ? "'{$data['expected_probability']}'" : 'NULL') . ', `minimum`=' . (($data['minimum'] != '') ? "'{$data['minimum']}'" : 'NULL') . ', `maximum`=' . (($data['maximum'] != '') ? "'{$data['maximum']}'" : 'NULL') . ', `reading_other_value`=' . (($data['reading_other_value'] != '') ? "'{$data['reading_other_value']}'" : 'NULL') . ', `comments`=' . (($data['comments'] != '') ? "'{$data['comments']}'" : 'NULL'));
	...
	if(function_exists('disease_symptoms_after_insert')){
		...
		$args=array();
		if(!disease_symptoms_after_insert($data, getMemberInfo(), $args)){ return; }
	}

	// mm: save ownership data
	sql("insert into membership_userrecords set tableName='disease_symptoms', pkValue='$recID', memberID='".getLoggedMemberID()."', dateAdded='".time()."', dateUpdated='".time()."', groupID='".getLoggedGroupID()."'");
...
function disease_symptoms_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	if(function_exists('disease_symptoms_before_delete')){
		$args=array();
		if(!disease_symptoms_before_delete($selected_id, $skipChecks, getMemberInfo(), $args)){ return FALSE; }
	}

	sql("delete from `disease_symptoms` where `id`='$selected_id'");
	...
	sql("delete from membership_userrecords where tableName='disease_symptoms' and pkValue='$selected_id'");
}
...
function disease_symptoms_update($selected_id){
	...
	sql('update `disease_symptoms` set `disease`=' . (($data['disease'] != '') ? "'{$data['disease']}'" : 'NULL') . ', `symptom`=' . (($data['symptom'] != '') ? "'{$data['symptom']}'" : 'NULL') . ', `expected_probability`=' . (($data['expected_probability'] != '') ? "'{$data['expected_probability']}'" : 'NULL') . ', `minimum`=' . (($data['minimum'] != '') ? "'{$data['minimum']}'" : 'NULL') . ', `maximum`=' . (($data['maximum'] != '') ? "'{$data['maximum']}'" : 'NULL') . ', `reading_other_value`=' . (($data['reading_other_value'] != '') ? "'{$data['reading_other_value']}'" : 'NULL') . ', `comments`=' . (($data['comments'] != '') ? "'{$data['comments']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'");

	// hook: disease_symptoms_after_update
	if(function_exists('disease_symptoms_after_update')){
		$args=array();
		if(!disease_symptoms_after_update($data, getMemberInfo(), $args)){ return FALSE; }
	}

	// mm: update ownership data
	sql("update membership_userrecords set dateUpdated='".time()."' where tableName='disease_symptoms' and pkValue='".makeSafe($selected_id)."'");
