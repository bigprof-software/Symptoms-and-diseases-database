<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'patient_symptoms' table. 
	...
	*/
	...
	function patient_symptoms_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function patient_symptoms_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function patient_symptoms_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['patient'], $data['symptom'], $data['observation_date'], $data['observation_time'], $data['symptom_value']
	...
	*/
	...
	function patient_symptoms_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function patient_symptoms_after_insert($data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['id'], $data['patient'], $data['symptom'], $data['observation_date'], $data['observation_time'], $data['symptom_value']
	...
	*/
	...
	function patient_symptoms_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function patient_symptoms_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function patient_symptoms_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function patient_symptoms_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function patient_symptoms_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function patient_symptoms_csv($query, $memberInfo, $args){
