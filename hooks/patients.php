<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'patients' table. 
	...
	*/
	 ...
	 *     $data['first_name'], $data['last_name'], $data['gender'], $data['birth_date'], $data['age'], $data['address'], $data['city'], $data['state'], $data['zip'], $data['home_phone'], $data['work_phone'], $data['mobile'], $data['other_details'], $data['comments'], $data['filed'], $data['last_modified']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id'], $data['first_name'], $data['last_name'], $data['gender'], $data['birth_date'], $data['age'], $data['address'], $data['city'], $data['state'], $data['zip'], $data['home_phone'], $data['work_phone'], $data['mobile'], $data['other_details'], $data['comments'], $data['filed'], $data['last_modified']
