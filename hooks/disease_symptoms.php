<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'disease_symptoms' table. 
	...
	*/
	 ...
	 *     $data['disease'], $data['symptom'], $data['expected_probability'], $data['minimum'], $data['maximum'], $data['reading_other_value'], $data['comments']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id'], $data['disease'], $data['symptom'], $data['expected_probability'], $data['minimum'], $data['maximum'], $data['reading_other_value'], $data['comments']
