<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'symptoms' table. 
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['description'], $data['comments']
