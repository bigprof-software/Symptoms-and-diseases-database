<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'diseases' table. 
	...
	*/
	...
	function diseases_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function diseases_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function diseases_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['short_name'], $data['latin_name'], $data['description'], $data['other_details'], $data['comments']
	...
	*/
	...
	function diseases_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function diseases_after_insert($data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['id'], $data['short_name'], $data['latin_name'], $data['description'], $data['other_details'], $data['comments']
	...
	*/
	...
	function diseases_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function diseases_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function diseases_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function diseases_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function diseases_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function diseases_csv($query, $memberInfo, $args){
