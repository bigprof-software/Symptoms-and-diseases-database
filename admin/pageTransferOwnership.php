	...
	if($sourceGroupID && $sourceMemberID && $destinationGroupID && ($destinationMemberID || $moveMembers) && $_GET['beginTransfer']!=''){
		...
		*/
		...
		if($moveMembers && $sourceMemberID!=-1){
			...
			sql("update membership_users set groupID='$destinationGroupID' where lcase(memberID)='$sourceMemberID' and groupID='$sourceGroupID'");
			...
			sql("update membership_userrecords set groupID='$destinationGroupID' where lcase(memberID)='$sourceMemberID' and groupID='$sourceGroupID'");
			...
			sql("update membership_userrecords set groupID='$destinationGroupID', memberID='$destinationMemberID' where lcase(memberID)='$sourceMemberID' and groupID='$sourceGroupID'");
			...
			sql("update membership_users set groupID='$destinationGroupID' where groupID='$sourceGroupID'");
			...
			if(!$srcGroupMembers){
				...
				sql("update membership_userrecords set groupID='$destinationGroupID' where groupID='$sourceGroupID'");
			...
			sql("update membership_userrecords set groupID='$destinationGroupID', memberID='$destinationMemberID' where groupID='$sourceGroupID'");
			...
			<tr>
				...
				<td class="tdCell">
					<?php
						...
						if($res=sql("select lcase(memberID), lcase(memberID) from membership_users where groupID='$sourceGroupID' order by memberID")){
